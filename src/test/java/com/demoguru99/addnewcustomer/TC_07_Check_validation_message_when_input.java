...
public class TC_07_Check_validation_message_when_input extends BaseTest {
	WebDriver driver;
...
//		managerHomePage = PageGeneratorManager.getPageGenerator().getManagerHomePage(driver);
	...
	@Test
	public void TC_07_CheckValidationMessage() {
		...
		log.info("Step 2: Input space to [Customer Name] textbox");
		addCustomerPage.inputToCustomerName("    ");

		log.info("Step 3: An error message: 'First character can not have space'");
