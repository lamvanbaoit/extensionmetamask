...
public class TC_12_Check_created_new_account_successfully extends BaseTest {
	WebDriver driver;
	...
	@Test
	public void TC_12_CheckNewAccount() {
		...
		log.info("Step 2: input to [Customer ID] text box");
		addAccountPage.inputToCustomerID(customerID);

		log.info("input to [Initial deposit] text box");
		addAccountPage.inputInitialDeposit("123123");

		log.info("input to [Account type] text box");
		addAccountPage.inputAccountType("Current");

		log.info("click [Submit] button");
		addAccountPage.clickToSubmit();

		log.info("A message: 'Account Generated Successfully!!!'");
		verifyEquals(addAccountPage.geElementText(driver, AddAccountPageUI.SUCCESS_MESSAGE),
